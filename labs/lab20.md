...
Begin by downloading [CS101\_Lab20.zip](src/CS101_Lab20.zip). Save the zip file in the **H:\\CS101** directory.
...
The task is similar to [Lab 19](lab19.html): implement a bouncing character animation.
