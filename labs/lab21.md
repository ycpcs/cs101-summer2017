...
Begin by downloading [CS101\_Lab21.zip](src/CS101_Lab21.zip). Save the zip file in the **H:\\CS101** directory.
...
The task is similar to [Lab 19](lab19.html) and [Lab 20](lab20.html), in which you implemented a bouncing character animation.
